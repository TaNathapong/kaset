...
<head>
    ...
    <title>ประวัติผู้ขนส่ง - GreenHouse</title>
    ...
    <div class="container">
        <div class="product-content-right">
                ...
                <div class="col-sm-6">
                    <div class="product-images">
                        <div class="product-main-img">
                            <img src="img/weir.jpg" class="img-circle" alt="Forest" width="304" height="236">
                        </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="product-inner">
                        <h2 class="product-name">ข้อมูลกิจการ</h2>
                        <hr/>
                        <div role="tabpanel">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home">
                                    <p> พื้นที่ : ขอนแก่น</p>
                                    <p>	ที่อยู่บริษัท : พระยืน อำเภอเมือง ขอนแก่น 40000</p>
                                    <p>	โทรศัพท์: 0624796962</p>
                                    <p>	มือถือ: 0897888673  ติดต่อ: อัจฉรา ศรีสุข</p>
                    ...
                    <div class ="row">
                        <div class ="col-md-8">
                            <div class="w3-content" style="max-width:1200px">
                                <img class="mySlides" src="img/fram-1.jpg" style="width:100%">
                                <img class="mySlides" src="img/fram-2.jpg" style="width:100%">
                                <img class="mySlides" src="img/fram-3.jpg" style="width:100%">

                                <div class="w3-row-padding w3-section">
                                    <div class="w3-col s4">
                                        <img class="demo w3-opacity w3-hover-opacity-off" src="img/fram-1.jpg" style="width:100%" onclick="currentDiv(1)">
                                    </div>
                                    <div class="w3-col s4">
                                        <img class="demo w3-opacity w3-hover-opacity-off" src="img/fram-2.jpg" style="width:100%" onclick="currentDiv(2)">
                                    </div>
                                    <div class="w3-col s4">
                                        <img class="demo w3-opacity w3-hover-opacity-off" src="img/fram-3.jpg" style="width:100%" onclick="currentDiv(3)">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="col-md-6 text-center">
            <a href="#">
                <img src="icon/008-man.png" style="height: 200px;padding: 15px;">
                <p>ประวัติการส่ง</p>
            </a>
        </div>
        <div class="col-md-6 text-center">
            <a href="shipping.html">
                <img src="icon/018-box-1.png"  style="height: 200px;padding: 15px;">
