...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="sr-only">รายการสินค้า</h1>
    <?php $ta = 1; $subta = 1;?>

    <?php while ( $ta <= 5) { ?>
                <div class="container" style="margin-top: 20px;">
                <div class="row">
                        <?php for ($subta ; $subta <= 4; $subta++) { ?>
                            <div class="col-md-3">
                            <div class="single-product">
                                <div class="product-f-image" style="border: solid 2px; border-radius: 5px; border-color: #a4a4a4;">
